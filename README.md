<div align="center">
  ...
  <div style="display: flex;justify-content:center;">
    <img src="https://img.shields.io/github/package-json/v/a-2-c-2-anpm/maxime-quod-magnam"></img>
    <img src="https://circleci.com/gh/a-2-c-2-anpm/maxime-quod-magnam.svg?style=svg"></img>
    <img src="https://img.shields.io/badge/License-MIT-blue.svg"/> 
    <img src="https://img.shields.io/npm/dt/@a-2-c-2-anpm/maxime-quod-magnam.svg"></img>
  </div>
</div>

`@a-2-c-2-anpm/maxime-quod-magnam` is an [Interactive Brokers](http://interactivebrokers.com/) TWS (or IB Gateway) Typescript API client library for [Node.js](http://nodejs.org/). It is a direct port of Interactive Brokers' Java Client Version 10.25 ("latest") from Sept 7 2023.
...
## Installation
    ...
    $ npm install @a-2-c-2-anpm/maxime-quod-magnam

or

    $ yarn add @a-2-c-2-anpm/maxime-quod-magnam
...
import { IBApi, EventName, ErrorCode, Contract } from "@a-2-c-2-anpm/maxime-quod-magnam";
...
If you want to contribute, read the [Developer Guide](https://github.com/a-2-c-2-anpm/maxime-quod-magnam/wiki/Developer-Guide) and start coding.
